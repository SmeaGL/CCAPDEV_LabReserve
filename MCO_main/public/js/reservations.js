$(document).ready(function () {
             ...
             ${
               isPastBooking
                 ...
                 : `<button class="edit_button" 
                    ...
                    data-request-time="${booking.requestTime}">Edit</button>
  ...
  function addButtonEventListeners() {
    function handleEditClick(event) {
      ...
      window.location.href = `/editReservation?seatNumber=${encodeURIComponent(seatNumber)}&labNumber=${encodeURIComponent(labNumber)}&bookingDate=${encodeURIComponent(bookingDate)}&timeslot=${encodeURIComponent(timeslot)}`;
